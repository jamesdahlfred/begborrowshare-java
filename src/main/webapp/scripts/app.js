...
var begborrowshareApp = angular.module('begborrowshareApp', ['http-auth-interceptor', 'tmh.dynamicLocale', 'ngResource', 'ngRoute', 'ngCookies', 'begborrowshareAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
